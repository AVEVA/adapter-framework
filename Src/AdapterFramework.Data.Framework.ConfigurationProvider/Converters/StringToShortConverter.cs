...
public class StringToShortConverter : JsonConverter<short>
{
    public override short Read(ref Utf8JsonReader reader, Type type, JsonSerializerOptions options)
    {
        if (reader.TokenType == JsonTokenType.String)
        {
            ...
            if (short.TryParse(reader.GetString(), out number))
            {
                return number;
            }
        }
    ...
    public override void Write(Utf8JsonWriter writer, short shortValue, JsonSerializerOptions options)
    {
