...
public class AdapterCommonConfigService : IAdapterCommonConfigService
{
    public AdapterCommonConfigService(IComponentConfigurationProvider adapterConfigurationProvider, IEdgeDataProtector edgeDataProtector)
    {
        ConfigurationProvider = adapterConfigurationProvider;
