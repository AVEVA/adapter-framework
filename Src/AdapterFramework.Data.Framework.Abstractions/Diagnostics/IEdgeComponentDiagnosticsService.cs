...
/// <summary>
/// Represents a service used to generate diagnostics data for <see cref="IEdgeComponent"/>.
/// </summary>
public interface IEdgeComponentDiagnosticsService : IDisposable
{        
    /// <summary>
    ...
    /// <summary>
    /// Starts the diagnostics service.
    /// </summary>
    /// <returns>A task that represents the asynchronous operation.</returns>
    Task StartAsync();

    /// <summary>
    /// Stops the diagnostics service.
    /// </summary>
    /// <returns>A task that represents the asynchronous operation.</returns>
    Task StopAsync();
