...
public class FailoverBackedUpOmfMessageQueue : BackedUpOmfMessageQueueBase<IFailoverSerializedOmfMessage>
{
    public FailoverBackedUpOmfMessageQueue(int maxVolatileMemorySize, TimeSpan messageExpirationTime, IPersistentMessageQueue<IFailoverSerializedOmfMessage> persistentQueue, ILogger logger) 
