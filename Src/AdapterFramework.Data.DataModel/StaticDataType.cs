...
/// <summary>
/// An object representing an OMF static type message.
/// </summary>
public class StaticDataType : DataType
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="StaticDataType"/> class.
    /// </summary>
    public StaticDataType(OmfVersion omfVersion = OmfVersion.Omf12)
    {
    ...
    {
        OmfVersion.Omf12 => Tokens.Static,
        OmfVersion.Omf20 => Tokens.Entity,
